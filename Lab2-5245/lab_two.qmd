...
fig, axs = plt.subplots(5, 3, tight_layout=True)
...
axs[4,0].hist(dist13, bins=n_bins, color='blue')
axs[4,0].axvline(np.median(dist4), color='k', linestyle='dashed', linewidth=1)

axs[4,1].hist(dist14, bins=n_bins, color='blue')
axs[4,1].axvline(np.median(dist8), color='k', linestyle='dashed', linewidth=1)

axs[4,2].hist(dist15, bins=n_bins, color='blue')
axs[4,2].axvline(np.median(dist12), color='k', linestyle='dashed', linewidth=1)
